...
const char MQTT_PUB_TOPIC1[] = "humedad/" LOCATION "/" HOSTNAME;
// Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/" LOCATION "/" HOSTNAME;

const char MQTT_BRIGHTNESS_TOPIC[] = "luminosidad/" LOCATION "/" HOSTNAME;
